...
122 E=A MOD 4
123 REM NOT A LEAP YEAR
124 IF (C=0)AND(E<>0) THEN SCHALT=0
125 IF SCHALT=0 THEN PR "NOT ";
126 PR "A LEAP YEAR"
127 F=A
...
152 WT=INT(F+F/4+I)
154 WT=WT+1
156 REM WEEKDAY FOR FIRST DAY OF MONTH, DAYS FOR EVERY MONTH
158 FOR M=1 TO 12
...
652 GOSUB 840
654 FOR L=1 TO 3
656 REM PRINT NAME OF WEEKDAYS
658 PR " ", TG$;
660 NEXT L
662 PR ""
664 GOSUB 1100
...
800 END
840 REM SUBROUTINE PRINT NAME OF MONTHS
...
890 RETURN
1100 REM SUBROUTINE PRINT LINES
1109 REM FIRST LINE
...
1168 REM SECOND UNTIL FOURTH LINE
1169 FOR R=1 TO 3
...
1288 NEXT R
1349 REM FIFTH LINE: END OF MONTH IS NEAR
...
1440 PR ""
1449 REM SIXTH LINE: END OF MONTH IN ANY CASE
